                        ...
                        <el-form :inline="true"
                            ...
                            <el-form-item label="密码">
                                <el-input placeholder="请输入密码"
                                            v-model="data.formList.password"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
                            <el-form-item label="昵称">
                                <el-input placeholder="请输入昵称"
                                            v-model="data.formList.nickname"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
                            <el-form-item label="头像">
                                <el-input placeholder="请输入头像"
                                            v-model="data.formList.avatar"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
...
<script lang="ts" setup>
    ...
    const data = reactive({
        ...
        detailUrl: '/name/user/item', // detailUrl:详情页面地址
